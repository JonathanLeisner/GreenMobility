...
delPFpath = timingPaths.simDELPF;  
delZpath =  zeros(size(timingPaths.simDELZ));
...
% First Guess: Myopia
wPath0 = timingPaths.wagePathMyopia;
pKPath0 = timingPaths.pKPathMyopia;
...
diary off
diary(strcat('timingTransitionLog',date,'_',num2str(hour(datetime('now'))),'.txt'))
diary on
...
save('TIMING_counterfactualRun_pf')
save('TIMING_rcf_pf','rcf_pf')
save('TIMING_L1cf_pf','L1cf_pf');
save('TIMING_LU1cf_pf','LU1cf_pf');
save('TIMING_Pcf_pf','Pcf_pf');
save('TIMING_pKcf_pf','pKcf_pf');
save('TIMING_wagecf_pf','wagecf_pf');
save('TIMING_Ppathcf_pf','Ppathcf_pf');
save('TIMING_VPathcf_pf','VPathcf_pf');
save('TIMING_VPathUcf_pf','VPathUcf_pf');
