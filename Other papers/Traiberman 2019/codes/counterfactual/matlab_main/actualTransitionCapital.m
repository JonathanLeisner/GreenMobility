...
actualPaths.simDELPF = simDELPF;
actualPaths.simDELZ = simDELZ;
actualPaths.wagePathMyopia = wVecT;
actualPaths.pKPathMyopia = pKVecT;
actualPaths.PPathMyopia = PPath;
actualPaths.VPathMyopia = VPath;

save('actualPaths','actualPaths')
