...
insheet using $timingInputs/varDecomp_TIMING.csv, clear c
format v* %4.1f
...
outsheet rowName amp v1 amp v2 amp v3 amp v4 lb using $tablePath/cfIncomeVarDecomp_timing.tex, noq replace non 
