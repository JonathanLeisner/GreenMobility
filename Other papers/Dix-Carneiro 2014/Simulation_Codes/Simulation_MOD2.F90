        ...
        while_loop: do while (.not. converged .and. it <= MAXIT)
            ...
            if (rank == 0) then
                ...
                if (t < HALF_YR_SIM - 10) then
                    ...
                    Cap = CapitalSim(:,HALF_YR_SIM - 10 - 1)
                    iter2(t) = 0
...
if (rank == 0) then
    ...
    do coh = HALF_YR_SIM - 40 - LAST_AGE, HALF_YR_SIM - 40 - FIRST_AGE
        ...
        open(unit = 1, file = 'AffectedWorkers_Pre2.csv')
    ...
    open(unit = 1, file = 'AffectedWorkers_Post2.csv')
    write(1,4738) 'ID','Cohort','Year','Educ','Choice','Exper','Welfare','Welfare2'
    do ind = 1, Size2 
        coh = coh_index(ind)
        n   = n_index(ind)
    ...
    open(unit = 1, file = 'Simulation2.csv')
    ...
    open(unit = 1, file = 'AdjCosts2.csv')
    ...
    open(unit = 1, file = 'Reallocation2.csv')
