...
! This code parallelizes the computation of aggregate supply of human capital, given human capital prices rsk
! Here, I impose static (myopic) expectations (first iteration)
...
! This code parallelizes the computation of aggregate supply of human capital, given human capital prices rsk
! Here, I impose the forecast rule given by parameters COEF_EXP and covar_EXP                           
