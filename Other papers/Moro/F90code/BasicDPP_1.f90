...
open(unit=init_data, file="/home/meghan/InitData_BasicDPP_1.txt", status="old", form="formatted", access="sequential")
...
open(unit=sim_data,file="/home/meghan/SimData_BasicDPP_1.txt",form="formatted", status="unknown")
do n=1,nobs,1
do t=1,ntdata,1
	write(sim_data,'(i5,A1,i2,A1,i1,A1,i1,A1,i1,A1,i1,A1,i1,A1,i1,A1,F10.2,A1,F10.2)')n,',',t,',',work(n,t),',',exper(n,t),',',educ(n),&
		',',lastwork(n,t),',',married(n,t),',',receivedoffer(n,t),',',sim_wage(n,t),',',sim_nlincome(work(n,t),n,t)
end do
end do
close(unit=sim_data)
